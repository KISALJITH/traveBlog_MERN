            ...
            <div className="comment__list mt-5">
              ...
              <div className="single__comment d-flex gap-3">
                ...
                <div className="comment__content">
                  ...
                  <p className='section__description'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi magni eius doloremque earum, aliquid fugit aspernatur alias repellat in provident!</p>
                  <span className="replay align-items-center gap-1">
